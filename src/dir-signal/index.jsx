...
const sigStyles = {
  ...
  lineNum: { fontFamily: 'Geist Mono', fontSize: 10.5, color: 'rgba(244,244,242,.45)', marginTop: 1 },
  ...
  lineFullMeta: { fontFamily: 'Geist Mono', fontSize: 10.5, color: 'rgba(244,244,242,.5)', marginTop: 2 },
  ...
  lineFullCost: { fontFamily: 'Geist Mono', fontSize: 10.5, color: 'rgba(244,244,242,.5)', marginTop: 2 },
  ...
  featChip: { display: 'flex', alignItems: 'center', gap: 4,
    ...
    color: '#FBD53D', fontFamily: 'Geist Mono', fontSize: 10.5,
    textTransform: 'uppercase', letterSpacing: 0.06 },
  ...
  billItemDesc: { fontFamily: 'Geist Mono', fontSize: 10.5, color: 'rgba(244,244,242,.45)', marginTop: 2 },
  ...
  planDesc: { fontFamily: 'Geist Mono', fontSize: 10.5, color: 'rgba(244,244,242,.5)', marginTop: 2 },
  ...
  addLineMeta: { fontFamily: 'Geist Mono', fontSize: 10.5, color: 'rgba(251,213,61,.6)',

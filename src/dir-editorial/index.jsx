...
const edS = {
  ...
  edLineMeta: { fontFamily: 'Geist Mono', fontSize: 9.5, color: 'rgba(244,244,242,.45)', marginTop: 2 },
  ...
  billRowMeta: { fontFamily: 'Geist Mono', fontSize: 9.5, color: 'rgba(244,244,242,.45)', marginTop: 2 },
  ...
  edBigMeta: { fontFamily: 'Geist Mono', fontSize: 9.5, color: 'rgba(244,244,242,.45)', marginTop: 3 },
  ...
  edBillMeta: { fontFamily: 'Geist Mono', fontSize: 9.5, color: 'rgba(244,244,242,.45)', marginTop: 3,
